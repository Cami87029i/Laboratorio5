    ...
    <div class="col-md-6">
        <div class="card-formulario">
            ...
            <form id="form-editar-libro">
                ...
                <div class="mb-3">
                    <label>Titulo</label>
                    <input type="text" class="form-control" name="titulo" value="<?php echo $libro['titulo']; ?>">
                </div>
                <div class="mb-3">
                    <label>Autor</label>
                ...
                <div class="mb-3">
                    <label>ISBN</label>
                    <input type="text" class="form-control" name="isbn" value="<?php echo $libro['isbn']; ?>">
                </div>
                <div class="mb-3">
                    <label>Categoria</label>
                    <input type="text" class="form-control" name="categoria" value="<?php echo $libro['categoria']; ?>">
                </div>
                <div class="mb-3">
                    <label>Stock</label>
                    <input type="number" class="form-control" name="stock" id="stock" value="<?php echo $libro['stock']; ?>" min="0">
                </div>
